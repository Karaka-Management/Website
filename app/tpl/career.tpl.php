                    ...
                    <div class="floater">
                        ...
                        <div class="flex">
                            <div class="box box1">
                                ...
                                <p>As a PHP backend developer you can contribute to our framework, add features to existing modules, fix bugs, implement tests or create completely new modules from the ground up.</p>
                            </div>

                            <div class="box box1">
                                <h1>JS Developer (Frontend)</h1>
                                <p>As a JS frontend developer you can contribute to our framework or improve the user interaction with our application, create tests and develop/improve exciting libraries.</p>
                            </div>

                            <div class="box box1">
                                <h1>Artist and/or Frontend</h1>
                                <p>If creating user interfaces or icons and images is your talent please contact us you will be able to work on our application layout, application images and website (whatver you prefer).</p>
                            </div>

                            <div class="box box1">
                                <h1>DevOps</h1>
                                <p>Well thought out workflows are key for an efficient and painless development & release process. You can optimize and implement new workflows for our organization with a lot of freedom.</p>
                            </div>
                        </div>
                    </div>
